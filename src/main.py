...
def get_args():
    ...
    parser.add_argument('-g_conv', type=str, default='GConv', help='Conv layer: GConv or GAttn')
    parser.add_argument('-g_pool', type=str, default='GPool', help='Pooling layer: GPool or GDiffPool')
    ...
    parser.add_argument('-clusters', nargs='+', type=int, default='9 8 7')
